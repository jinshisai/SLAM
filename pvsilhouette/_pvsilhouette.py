...
#    def __init__(self):
    ...
    def fitting(self, incl: float = 90,
        ...
        ax.errorbar(self.x, vobs[0][0], yerr=vobserr[0][0], fmt='ob')
        ax.errorbar(self.x, vobs[0][1], yerr=vobserr[0][1], fmt='ob')
        ...
        ax.errorbar(self.x, vobs[1][0], yerr=vobserr[1][0], fmt='ob')
        ax.errorbar(self.x, vobs[1][1], yerr=vobserr[1][1], fmt='ob')
